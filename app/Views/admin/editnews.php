    ...
    <div class="wrapper addbook mt-3">
        <form action="/admin/editnews" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3 w-50">
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="Bülten Başlığı" value="<?php echo $news->title; ?>">
            </div>
            ...
            <div class="form-group mt-3 row">
                <div class="col-md-6 col-sm-12">
                    <p>Mevcut Bülten Fotoğraf</p>
                    <img src="/img/news/<?php echo $news->img; ?>" style="max-width: 300px;" alt="">
                </div>
                <div class="col-md-6 col-sm-12">
                    <label for="fileInput">Yeni Bülten Fotoğrafı</label>
