...
<head>
    ...
    <title>Mendirek</title>
    <meta name="description" content="Mendirek">
                        ...
                        <div>
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        <?php foreach ($books as $book) : ?>
                                                            <div class="swiper-slide">
                                                                ...
                                                                <p class="bookname"> <?php echo $book["name"] ?> </p>
                            ...
                            <div class="mod_container ">
                                <div class="container">
                                    <div class="Box box_prd box_prd_slide">
                                        <div class="Box-header">
                                            <a href="//one-cikanlar-1">Popüler</a>
                                        </div>
                                        <div class="Box-content" style="margin-top: 20px;">
                                            <div class="Carousel-wrapper" style="padding: 0 70px;position: relative;">
                                                <div class="swiper mySwiper-Populer" style="height: fit-content;">
                                                    <div class="swiper-wrapper">
                                                        <?php for ($i = 15; $i < 30; $i++) : ?>
                                                            <div class="swiper-slide">
                                                                <img style="width: 100%;height: auto;max-width: 200px;aspect-ratio: 100/87;" <?php echo 'src="/img/books/' . $i . '.jpeg"'; ?> />
                            ...
                            <div class="mod_container ">
                                <div class="container">
                                    <div class="Box box_prd box_prd_slide">
                                        <div class="Box-header">
                                            <a href="//one-cikanlar-1">Çok Satanlar</a>
                                        </div>
                                        <div class="Box-content" style="margin-top: 20px;">
                                            <div class="Carousel-wrapper" style="padding: 0 70px;position: relative;">
